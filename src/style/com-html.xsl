...
-->
    ...
    <xsl:template name="fHtmlStyle">
        <style type="text/css">
            ...
            Times, serif; } h1,h2,h3,h4,h5,h6 { text-align: left;
            font-family: Times, serif; } h1.book-title { text-align: center;
            font-family: Times, serif; } h2.subtitle { text-align: center;
            font-family: Times, serif; } h2.ch-title { text-align: left;
            font-family: Times, serif; } h3.prolog-title { text-align: left;
            font-family: Times, serif; } hr { width: 100%; margin: 2em auto
            2em auto; height: 2px; border-style: solid; border-color:
            #000000; clear: both; } hr.prolog { width: 33%; margin: 2em auto
            2em 0; align: left; height: 2px; border-style: solid;
            border-color: #000000; clear: both; } hr.break { width: 33%;
            margin: .7em auto .7em auto; align: center; height: 0px;
            border-style: solid; border-color: #ffffff; clear: both; } pre {
            font-size: 90%; font-family: Courier, monospace; } p {
            text-indent: 2em; margin-top: .1em; margin-bottom: .1em;
            font-family: Times, serif; } p.author { text-indent: 0;
            text-align: center; margin-top: .2em; margin-bottom: .2em;
            font-family: Times, serif; } p.block { text-indent: 0;
            margin-top: .5em; margin-bottom: .5em; font-family: Times, serif;
            } p.quote { text-indent: 0; margin-top: 1em; margin-bottom: 1em;
            margin-left: 10%; margin-right: 10%; font-family: Times, serif; }
            font.draft { color: red; font-style: italic; } font.change {
            color: blue; text-decoration: underline } font.ins { color:
            green; text-decoration: underline } font.del { color: red;
            text-decoration: line-through } div.change { color: blue;
            text-decoration: underline } div.ins { color: green;
            text-decoration: underline } div.del { color: red;
            text-decoration: line-through }</xsl:comment>
        </style>
    </xsl:template>

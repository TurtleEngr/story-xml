  ...
  <xsl:template name="fDefBook">
    ...
    <table border="1"
      ...
      <tr align="left"
        ...
        <td>
          <p class="block">
            <font class="draft">Black text will print in final non-draft
            copy.</font>
          </p>
        </td>
      </tr>
      ...
      <tr align="left"
        ...
        <td>
          <p class="block">
            <font class="draft">This is deleted text, which only prints in
            draft copies, if the @deleted draft option is on.</font>
          </p>
        </td>
      </tr>
      <tr align="left"
        ...
        <td>
          <p class="block">
            <font class="draft">This is changed text. It will be black in
            non-draft copies.</font>
          </p>
        </td>
      </tr>
      <tr align="left"
        ...
        <td>
          <p class="block">
            <font class="draft">This is added text. It will be black in
            non-draft copies.</font>
          </p>
        </td>
      </tr>
      <tr align="left"
        ...
        <td>
          <p class="block">
            <div class="ins">
              <font class="draft">Red, Italic, with Green Underline</font>
            </div>
          </p>
        </td>
        <td>
          <p class="block">
            <font class="draft">This is draft text in a block that has a
            RevisionFlag="added". It will only print in draft copies, if
            the @deleted draft option is on.</font>
          </p>
        </td>
      </tr>
      <tr align="left"
        ...
        <td>
          <p class="block">
            <div class="change">
              <font class="draft">Red, Italic, with Blue Underline</font>
            </div>
          </p>
        </td>
        <td>
          <p class="block">
            <font class="draft">This is draft text in a block that has a
            RevisionFlag="changed". It will only print in draft
            copies.</font>
          </p>
        </td>
      </tr>
      <tr align="left"
        ...
        <td>
          <p class="block">
            <font class="draft">This is draft text in a block that has a
            RevisionFlag="deleted". It will only print in draft
            copies.</font>
          </p>
        </td>
      </tr>
...
<xsl:value-of select="story-info/def-when/@gmt" />
  ...
  <xsl:template match="def-when"
    ...
    <p class="block">(Note: end-date will get it's default values from the
    start-date.)</p>
  </xsl:template>
  <!-- ******************** -->

...
<xsl:stylesheet version="1.0"
  ...
  <!--
$Header: /repo/local.cvs/app/story-xml/src/story3/story-com-html.xsl,v 1.9 2008/02/24 19:21:46 bruce Exp $
-->
  <!-- ******************** -->
...
-->
  ...
  <xsl:template name="fLinkDefault">
    <xsl:variable name="link" select="key('def-link-index', @ref)" />

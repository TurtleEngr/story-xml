<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" >
  ...
  <xsl:key name="def-draft-index" match="def" use="@id"/>
  <xsl:key name="def-thread-index" match="def" use="@id"/>
...
<!--
<source>$Source: /repo/local.cvs/app/story-xml/old/src/extra.xsl,v $</source>
<revision>$Revision: 1.1 $</revision>
<revision-date>$Date: 2005/01/16 02:30:55 $</revision-date>
